...
Również rozmiar zdaje się nie wykazwyać żadnej zależności względem jakości szlifu.SS
...
```{r}
ggplot(diamonds, aes(x = interaction(color, clarity), y = carat, fill = color)) +
